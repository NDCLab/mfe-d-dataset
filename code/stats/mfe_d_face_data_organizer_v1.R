# This script will load, and organize the Psychopy data for the mfe_d (face) study.
...
# Last Update: 2024-10-01 (YYYY-MM-DD)
...
for(subject in 1:length(datafiles_list)){
  ...
  psychopyDatTrim <- psychopyDat[c("id",
                                   ...
                                   "faceDisp_plus_faceDelay_time", # the length of the second routine
                                   ...
                                   "cover_background_2.started", # allows to remove the flanker practice trials
  ...
  remove_prac_trials <- subset(psychopyDatTrim, !complete.cases(psychopyDatTrim$cover_background_2.started)) # removes practice trials
